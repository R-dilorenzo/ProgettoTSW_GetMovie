...
/* fine CSS per autocompletamento*/
...
<div class="x" name="x" id="x">
  ...
  <div id="Day">
    ...
    <div id="LocalSt">DAY/NIGHT: Il tuo browser non supporta questa funzionalità</div>
    </div>
		...
		<div class="tab-pane active" id="Film">
			<div class="container">
				...
				%>
					...
					<div  class="col-sm col-md-4 col-lg-3 d-flex align-items-stretch" style="padding-top:20px;padding-bottom:20px;">
						<div class="card" style="width: 13rem;">
							<a href="InfoFilm?nome=<%=pre.getNome() %>"><img src="<%=pre.getImg()%>" class="card-img-top img-fluid"
								alt="<%=pre.getImg()%>" style="height:20rem"></a>
							<div class="card-body" name="cardB">
							<div style="height:5rem;">
								<h5 class="card-title"><%=pre.getNome()%></h5>
								<small class="text-muted"><p class="card-text"><%=pre.getGenere()%></p></small>
